...
There are different types of frameworks that implement the reference architecture. These are a few examples:
\begin{itemize}
	\item[$\bullet$] GlassFish Server 3.01
	\item[$\bullet$] WebSphere Application Server 8.x
	\item[$\bullet$] WebLogic Server 12.1.1
	\item[$\bullet$] JBoss Application Server 7.x
	\\
\end{itemize}
\newpage
In addition the above mentioned frameworks there are countless other open-source frameworks that implement the JAVA-EE reference architecture. These are a few examples:
\begin{itemize}
	\item[$\bullet$] GlassFish Server Open Source Edition 3.x
	\item[$\bullet$] WebSphere Application Server Community Edition 3.0
	\item[$\bullet$] JBoss Enterprise Application Platform 6
	\item[$\bullet$] Wildfly
	\\
\end{itemize}
...
\begin{flushleft}
Solms, F. 2015.Reference Architectures. In: Lecture notes issued online. University of Pretoria. Pretoria, South Africa

Marshall, A. 2015. Top 10 Open Source Java and JavaEE Application Servers
Available from: https://blog.idrsolutions.com/2015/04/top-10-open-source-java-and-javaee-application-servers/
[Accessed: 11 March 2016]

MARKUS, E. 2013. Selecting Your Java EE 6 Application Server
Available from: http://blog.eisele.net/2013/01/selecting-your-java-ee-6-application.html
[Accessed: 11 March 2016]
